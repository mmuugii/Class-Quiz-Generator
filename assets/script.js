...
const exit_btn = info_box.querySelector(".endButtons .quit");
const continue_btn = info_box.querySelector(".endButtons .continue");
...
start_btn.onclick = ()=> {
    info_box.classList.add("activeInfo"); // to show info box
}
// if exitQuiz button clicked
exit_btn.onclick = ()=> {
    info_box.classList.remove("activeInfo"); // to hide info box
}
...
const restart_quiz = result_box.querySelector(".endButtons .continue");
const quit_quiz = result_box.querySelector(".endButtons .quit");
...
function optionSelected(answer) {
    // for (var i = 0; option_list.length; i++) {
    //     if (option_list[i].checked) {
    //         var choice = option_list[i].value;
    //     };
    // }
    var choice = answer.innerText;
